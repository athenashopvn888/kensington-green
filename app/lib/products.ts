...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Kensington Green?", a: "Yes! Visit us at 2257 Dundas St W, Toronto. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  CIGARETTES: {
    ...
    seoDescription: "Kensington Green is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 2257 Dundas St W in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
