...
export function getItemData(category: string, name: string): ItemEffects {
  ...
  if (cat === "EDIBLES") {
    return {
      ...
      metaDescription: `Buy ${name} cannabis edibles in Toronto at Kensington Green. Consistent, discreet, and long-lasting effects. Walk-in available 24/7.`,
  ...
  if (cat.includes("VAPE")) {
    return {
      ...
      metaDescription: `Shop ${name} vape pens and cartridges in Toronto at Kensington Green. Fast-acting and potent. Walk-in available 24/7.`,
  ...
  if (cat === "CONCENTRATES") {
    return {
      ...
      metaDescription: `Buy ${name} cannabis concentrate in Toronto at Kensington Green. Highly potent and pure extracts. Walk-in available 24/7.`,
  ...
  if (cat === "PREROLLS") {
    return {
      ...
      metaDescription: `Get ${name} pre-rolled joints in Toronto at Kensington Green. Premium flower, perfectly rolled. Walk-in available 24/7.`,
  ...
  if (cat === "MAGIC & OTHERS") {
    return {
      ...
      metaDescription: `Shop ${name} magic mushrooms and psilocybin products in Toronto at Kensington Green. High quality and consistent. Walk-in available 24/7.`,
  ...
  return {
    ...
    metaDescription: `Buy ${name} in Toronto at Kensington Green. Premium quality and best prices. Walk-in available 24/7.`,
