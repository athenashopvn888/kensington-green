...
export const TIER_SEO: Record<string, TierSeoData> = {
  EXOTIC: {
    ...
    seoIntro: "Explore the Exotic tier at Kensington Green — our most exclusive cannabis flower selection. Hand-picked strains with THC levels up to 39%, stunning bag appeal, and unique terpene profiles you won't find anywhere else in Toronto.",
    sections: [
      {
  ...
  PREMIUM: {
    ...
    seoIntro: "Shop Premium cannabis flower at Kensington Green, Toronto. Connoisseur-grade strains with THC 32-34%, exceptional flavour, and smooth smoke. Starting at $15/g.",
    sections: [
      {
      ...
      },
      {
        ...
        body: "At Kensington Green on Toronto St, our Premium tier offers the best quality-to-price ratio in the neighbourhood. Every strain in this tier has been personally vetted by our team for potency, flavour, and bag appeal.",
      },
    ],
    faqs: [
  ...
  "AAA+": {
    ...
    seoIntro: "Shop AAA+ cannabis flower at Kensington Green, Toronto. Strong, reliable strains with THC 30-32% starting at just $10/g. The best value for experienced smokers.",
    sections: [
      {
  ...
  AA: {
    ...
    seoIntro: "Shop AA cannabis flower at Kensington Green, Toronto. Solid everyday strains with THC 27-29% at just $5/g. Perfect for regular smokers on a budget.",
    sections: [
      {
  ...
  BUDGET: {
    ...
    seoIntro: "Cheap weed in Toronto starting at $3/g. Kensington Green Budget tier features shreds and value ounces for cost-conscious smokers. Check current store hours before visiting Kensington Green.",
    sections: [
      {
        heading: "Affordable Cannabis Without Compromise",
        body: "Our Budget tier proves that affordable cannabis doesn't mean low quality. With THC levels from 24% to 27%, these value strains deliver solid effects at rock-bottom prices. Whether you're looking for shreds or value ounces, Kensington Green has the cheapest weed in Toronto's ByWard Market neighbourhood.",
      },
      {
        heading: "Budget Pricing — From $3/g, OZs from $40",
        body: "Budget flower starts at just $3 per gram. Value ounces start from $40 — some of the best prices you'll find in Toronto. Our 3g bundle pricing applies here too, giving you even more savings.",
      },
    ],
    faqs: [
      { q: "What is the cheapest weed at Kensington Green?", a: "Our Budget tier starts at $3/g with value ounces from $40. These are quality strains at the lowest possible price." },
