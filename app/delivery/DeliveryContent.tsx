    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Kensington Green is launching delivery across Toronto.
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            Can&apos;t wait? Visit us in-store at <strong>2257 Dundas St W, Toronto</strong> —
            we are <strong>Open Daily: 10:00 AM - 02:00 AM</strong>. Call <strong>(416) 402-5263</strong>.
          </p>
        </div>
      </div>
      <Footer />
