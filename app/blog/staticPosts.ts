...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "Kensington Green Cannabis Menu Check on Dundas West",
    "seoTitle": "Kensington Green Cannabis Menu Check on Dundas West | Toronto",
    "seo_title": "Kensington Green Cannabis Menu Check on Dundas West | Toronto",
    "metaDescription": "Kensington Green Cannabis Menu Check on Dundas West with address, hours, phone, menu-category checks, and practical planning notes for Toronto shoppers.",
    "meta_description": "Kensington Green Cannabis Menu Check on Dundas West with address, hours, phone, menu-category checks, and practical planning notes for Toronto shoppers.",
    "h1": "Kensington Green Cannabis Menu Check on Dundas West",
    "excerpt": "A practical Toronto store-page and menu check for Kensington Green Cannabis, with address, hours, phone, and browsing tips.",
    "authorName": "Kit Kensington",
    "authorHandle": "@KitInKensington",
    "authorRole": "House Writer",
    "author": "By Kit Kensington \\u00b7 @KitInKensington",
    "structuredAuthorName": "Kensington Green Cannabis Editorial Team",
    "date": "2026-07-02",
    "modifiedDate": "2026-07-11",
    "category": "Store Guide",
    "readTime": "4 min",
    "content": "Quick answer: Kensington Green Cannabis is listed at 2257 Dundas St W, Toronto, ON M6R 1X6. The listed phone number is (416) 402-5263, and the site lists the store as open daily from 10 AM to 2 AM. If you are checking a weed dispensary in Toronto, start with the store page, then move into the menu category that matches the trip. That keeps the browse clean and keeps old screenshots from bossing you around.\n\n## Start With The Right Store Page\n\nThe local anchor is Dundas St W in Toronto. Use that as the first sanity check before you compare anything else. The web gets messy when store names, neighbourhood names, and old tabs start floating around. The easiest fix is not fancy: match the address, match the phone number, then browse from the current site navigation.\n\nBecause the site lists late hours, it can be useful for people searching for an open late cannabis store or weed dispensary in Toronto. Check the live page before leaving, because hours are only useful when they are current. This is especially true if you are trying to make a quick stop. A stale menu tab can make a simple cannabis store run feel like a treasure hunt, and nobody needs that extra drama.\n\n## Browse By Product Lane\n\nThe fastest path is to pick the lane first. Flower shoppers can start with Budget, AA, AAA+, Premium, or Exotic flower. People looking for something already rolled can jump into pre-rolls. Edibles, THC vapes, concentrates, accessories, and cigarettes each deserve their own check instead of being mashed into one giant scroll.\n\nIf cheap weed or affordable weed is the point, begin in Budget and AA before comparing the higher flower tiers. If premium flower or exotic flower is the mood, go straight there and compare the current listings. The point is not to memorize every page. The point is to stop wandering through pages that were never your lane.\n\n## What To Check Before Leaving\n\nBring valid government ID. Confirm the address, hours, and phone number on the store page. If you need one exact item, check the live category page and call the listed number when a yes-or-no answer matters. Menu pages can change, and that is normal; the current page beats a saved tab every time.\n\nOne extra check helps for Toronto: keep the store page open until the trip is actually happening, so the address, phone, hours, and category links are still the current version instead of whatever an old browser tab remembered.\n\nFor a Toronto cannabis dispensary search, this guide is the calm version of the checklist: verify the store, choose the lane, then use the live page for the details. Use the live store pages for the current information before visiting.\n\n## FAQ\n\n### Where is Kensington Green Cannabis?\nKensington Green Cannabis is listed at 2257 Dundas St W, Toronto, ON M6R 1X6.\n\n### What hours are listed?\nThe site lists Kensington Green Cannabis as open daily from 10 AM to 2 AM.\n\n### Does this article confirm current stock?\nNo. Use the current menu and category pages for current listings before visiting.\n\n### What should shoppers bring?\nBring valid government identification and use the store page for the current visit details.",
    "faq": "",
    "internal_links_used": "[Flower menu](/premium)\\n[Current menu categories](/)\\n[Kensington Green Cannabis store page](/weed-dispensary-toronto)\\n[Kensington Green Cannabis blog](/blog)",
    "relatedLinks": [
      {
        "title": "Flower menu",
        "url": "/premium",
    ...
    "editorialRemark": {
      ...
      "authorName": "Olive Green",
      "authorHandle": "@OliveKensington",
      "authorRole": "House Writer",
      "body": "The address check is not boring; it is the part that saves the trip. Store names and old tabs can blur together, so matching Dundas St W, the phone number, and the current page is worth the minute. Use the live page before visiting."
    },
  ...
  },
  {
    ...
    "editorialRemark": {
      "label": "Another House Writer Adds",
      "authorName": "Kensington Green Desk",
      "authorHandle": "@KensingtonGreenDesk",
    ...
    "primaryKeyword": "flower menu Toronto",
    "keywords": [
      "weed dispensary in Toronto",
      "cannabis store in Toronto",
      "Toronto weed store",
  ...
  },
  {
    ...
    "primaryKeyword": "cannabis menu Toronto",
    "keywords": [
      "weed dispensary in Toronto",
      "cannabis store in Toronto",
      "Toronto weed store",
    ...
    "oldTitle": "Kensington Green Local Visit Guide for Adults 19+",
    "wordCount": 537,
    "businessReviewFlags": []
  }
];
