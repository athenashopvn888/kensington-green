...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Kensington Green Price And Flower Tier Guide for Adults 19+",
    seoTitle: "Kensington Green Price Tier Guide | Adult 19+",
    seo_title: "Kensington Green Price Tier Guide | Adult 19+",
    metaDescription: "Adult 19+ guide to Kensington Green flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "Adult 19+ guide to Kensington Green flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "Kensington Green Price And Flower Tier Guide for Adults 19+",
    excerpt: "A simple adult 19+ guide to Kensington Green flower tiers, weights, and unit value.",
    author: "The Kensington Green Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Kensington Green Price And Flower Tier Guide for Adults 19+

Kensington Green keeps flower browsing simple for adults 19+ by organizing options into clear price and quality tiers. Instead of guessing where to start, shoppers can pick the grade they want first, then choose the weight that fits the visit and budget.

This guide explains how the tier ladder works, how unit value improves as the weight goes up, and how to use the live menu and store page before visiting near Kensington Market in Toronto.
...
For the smoothest visit, open the Kensington Green menu before heading out. The live menu is the best place to compare current categories, weights, and store-specific options. The store page is also useful for directions, contact details, and quick visit planning.

If you are comparing flower tiers from Toronto, use this page as a simple guide, then use the live menu for the current selection.

## Helpful Next Steps

- Browse the Kensington Green store page for directions, contact details, and visit planning.
...
This guide is for adults 19+ who want a simple way to understand Kensington Green flower tiers before visiting.`,
    faq: "",
    internal_links_used: "[Kensington Green store page](/weed-dispensary-toronto)\\n[Kensington Green homepage](/)\\n[More Kensington Green guides](/blog)",
    relatedLinks: [
      {
