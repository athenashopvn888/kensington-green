...
export const STATIC_POSTS: StaticBlogPost[] = [
  ...
  },
  {
    ...
    "title": "How to Compare Kensington Green Cannabis Flower Without Guessing",
    "seoTitle": "Kensington Green Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Kensington Green Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Kensington Green Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Kensington Green Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Kensington Green Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Kensington Green Cannabis.",
    "authorName": "Olive Green",
    "authorHandle": "@OliveKensington",
    "authorRole": "House Writer",
    "author": "Olive Green",
  ...
  },
  {
    ...
    "title": "How to Shop the Kensington Green Cannabis Menu Like a Pro",
    "seoTitle": "Kensington Green Cannabis Menu Guide | Kensington Market Weed Store",
    "seo_title": "Kensington Green Cannabis Menu Guide | Kensington Market Weed Store",
    "metaDescription": "Shop the Kensington Green Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Kensington Green Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Kensington Green Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Kensington Green Cannabis menu without turning the visit into a guessing game.",
    "authorName": "Kit Kensington",
    "authorHandle": "@KitInKensington",
    "authorRole": "House Writer",
    "author": "Kit Kensington",
