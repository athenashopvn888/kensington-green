...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    author: "The Kensington Green Team",
    date: "2026-07-02",
...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Kensington Green Price and Flower Tier Guide",
    seoTitle: "Kensington Green Price Tier Guide",
    seo_title: "Kensington Green Price Tier Guide",
    metaDescription: "Kensington Green guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "Kensington Green guide to flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "Kensington Green Price and Flower Tier Guide",
    excerpt: "A simple guide to Kensington Green flower tiers, weights, and unit value.",
    author: "The Kensington Green Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Kensington Green Price and Flower Tier Guide

Kensington Green makes flower shopping easier by organizing the menu into clear tiers. Start with the tier that matches the kind of flower you want, then choose the weight that fits your budget and visit.
...
For the smoothest visit, open the Kensington Green menu before heading out. The live menu is the best place to compare current flower tiers, weights, and store-specific options. The store page is also useful for directions, contact details, and visit planning.

If you are comparing flower tiers in Toronto, use this page as the simple guide, then use the live menu for the current selection.

## Helpful Next Steps

- Compare [Exotic flower](/exotic), [Premium flower](/premium), [AAA+ flower](/aaa), [AA flower](/aa), and [Budget flower](/budget).
- Open the Kensington Green store page for directions, contact details, and visit planning.
...
Use the live menu for current store-specific selection, then use the store page for directions, contact details, and visit planning.`,
  ...
  },
  {
    ...
    title: "Kensington Green Local Visit Guide for Adults 19+",
    seoTitle: "Kensington Green Local Visit Guide | Toronto Adult 19+",
    seo_title: "Kensington Green Local Visit Guide | Toronto Adult 19+",
    metaDescription: "Plan a visit to Kensington Green in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    meta_description: "Plan a visit to Kensington Green in Toronto with adult 19+ store-page checks, menu-category paths, and local directions context.",
    h1: "Kensington Green Local Visit Guide for Adults 19+",
    excerpt: "Kensington Green guide for adults 19+ checking local context, store pages, and menu-category paths around Dundas West / Roncesvalles / High Park.",
    author: "The Kensington Green Team",
    date: "2026-07-09",
    category: "Local Guide",
    readTime: "5 min",
    content: `Use this guide to confirm the right Kensington Green storefront around Dundas West / Roncesvalles / High Park, understand nearby street context, and choose the most useful store page or menu path before visiting.

For current details, start with the official store page or contact staff before leaving.

## Confirm The Right Storefront

Kensington Green is tied to Dundas West, Roncesvalles, High Park, west Toronto. Local shoppers often compare several nearby search results, so the first job of this page is to make the store identity, area context, and next click easy to understand.
...
Searches near Dundas West / Roncesvalles / High Park usually come from shoppers who already have a real-world route in mind. Mentioning nearby streets, neighbourhood language, and local travel context helps the page match how people actually search without inventing claims.
...
- Open the Kensington Green store page: [https://www.kensingtongreencannabis.com/weed-dispensary-toronto](https://www.kensingtongreencannabis.com/weed-dispensary-toronto)
- Browse more local guides from the blog: [https://www.kensingtongreencannabis.com/blog](https://www.kensingtongreencannabis.com/blog)
- Confirm store-specific details before heading out.

## FAQ

### Is this guide only for Kensington Green?

Yes. This page is written for Kensington Green and the Dundas West / Roncesvalles / High Park area.
...
Local shoppers search with neighbourhood and street language. Clear local context helps them confirm they are looking at the right store.`,
    ...
    internal_links_used: "/weed-dispensary-toronto, /blog, /blog/kensington-green-local-visit-guide-2026",
    relatedLinks:     [
          {
                "title": "Kensington Green store page",
                "url": "https://www.kensingtongreencannabis.com/weed-dispensary-toronto",
                "description": "Official Kensington Green page for local visit planning."
          },
          {
                "title": "Kensington Green homepage",
                "url": "https://www.kensingtongreencannabis.com/",
                "description": "Start from the Kensington Green homepage."
          },
          {
                "title": "More Kensington Green guides",
                "url": "https://www.kensingtongreencannabis.com/blog",
