...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Kensington Green is Toronto's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=KSC01`)
      .then((r) => r.json())
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Kensington Green <span className={styles.heroAccent}>Blog</span>
          </h1>
