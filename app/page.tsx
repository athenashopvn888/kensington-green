...
const LOCAL_FAQS = [
  {
    ...
    a: "Kensington Green at 2257 Dundas St W, Toronto is Open 24 Hours a day, 7 days a week. Walk in anytime — no appointment needed.",
  },
  {
      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            <h2 className={styles.seoPanelTitle}>2257 Dundas St W & Nearby Expressway's Premier Cannabis Dispensary — Open 24 Hours</h2>
            <p className={styles.seoPanelText}>
              Welcome to <strong>Kensington Green</strong>, Toronto's premier 24-hour cannabis destination at 2257 Dundas St W. We carry an electrifying selection of top-shelf strains around the clock — from ultra-rare exotics to solid everyday budget picks.
            </p>
            <p className={styles.seoPanelText}>
              Open 24 hours, 7 days a week — Kensington Green never closes. Our live menu is constantly refreshed with the freshest drops, premium prerolls, artisan edibles, and everything in between. Whether you're winding down after a late shift or stocking up for the weekend, our knowledgeable staff is always here for you.
            </p>
            <p className={styles.seoPanelText}>
              Searching for a cannabis dispensary in Toronto or the surrounding area? Kensington Green is your 24-hour destination for premium flower, potent prerolls, and artisan edibles. Our six-tier pricing system means quality cannabis at every budget level — starting from just $3/g.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className={styles.storeSection} id="contact">
        <div className={styles.container}>
          ...
          <div className={styles.mapWrap}>
            <iframe
              src="https://maps.google.com/maps?q=2257%20Dundas%20St%20W,+Toronto,+ON+M6R%201X6&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="350"
              ...
              title="Kensington Green — 2257 Dundas St W, Toronto"
            ></iframe>
          </div>
        </div>
      </section>
