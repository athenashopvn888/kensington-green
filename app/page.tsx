...
const LOCAL_FAQS = [
  {
    ...
    a: "Kensington Green at 2257 Dundas St W, Toronto is open daily from 10:00 AM to 02:00 AM. Walk in anytime â€” no appointment needed.",
  },
  {
        ...
        <section className={styles.welcomeBannerSection}>
          <div className={styles.welcomeBannerContainer}>
            <img
              ...
              alt="Welcome to Kensington Green â€” Premium Toronto Cannabis Dispensary"
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.brandBlock}>
            <img src="/storeFavicon.webp" alt="Kensington Green Icon" style={{ height: "60px", width: "60px", objectFit: "contain", borderRadius: "8px", marginBottom: "8px" }} />
      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            <h2 className={styles.seoPanelTitle}>2257 Dundas St W & Nearby Expressway's Premier Cannabis Dispensary â€” Open Daily: 10:00 AM - 02:00 AM</h2>
            <p className={styles.seoPanelText}>
              Welcome to <strong>Kensington Green</strong>, Toronto's premier cannabis destination at 2257 Dundas St W. We carry an electrifying selection of top-shelf strains â€” from ultra-rare exotics to solid everyday budget picks.
            </p>
            <p className={styles.seoPanelText}>
              We are open Open Daily: 10:00 AM - 02:00 AM â€” Kensington Green is here to serve you. Our live menu is constantly refreshed with the freshest drops, premium prerolls, artisan edibles, and everything in between. Whether you're winding down or stocking up for the weekend, our knowledgeable staff can help during listed store hours.
            </p>
            <p className={styles.seoPanelText}>
              Searching for a cannabis dispensary in Toronto or the surrounding area? Kensington Green is your go-to destination for premium flower, potent prerolls, and artisan edibles. Our six-tier pricing system means quality cannabis at every budget level â€” starting from just $3/g.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className={styles.storeGrid}>
            ...
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                ...
                <br />
                <span className={styles.storeHighlight}>2257 Dundas St W & Nearby Expressway, Toronto</span>
              </p>
            </div>
          </div>
