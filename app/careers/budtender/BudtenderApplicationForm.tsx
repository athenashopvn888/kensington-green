...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="KSC01" />
      <input type="hidden" name="StoreName" value="Kensington Green" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Kensington Green?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Airport Road for scheduled shifts?</legend>
        ...
        <label className={styles.consentLine}>
          ...
          <span>I understand my response will be stored in the hiring response sheet.</span>
        </label>
      </div>
