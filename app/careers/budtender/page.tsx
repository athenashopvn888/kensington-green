...
export const metadata: Metadata = {
  title: { absolute: "Budtender Or Manager Application | Kensington Green" },
  description:
    "Apply for budtender or manager opportunities at Kensington Green in Toronto. Submit availability, retail experience, motivation, determination, and customer-service answers.",
  alternates: {
    canonical: "https://www.kensingtongreencannabis.com/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with Kensington Green.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>Kensington Green Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Kensington Green is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Late-shift availability is a plus at Kensington Green</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className={styles.contentGrid}>
          ...
          <section id="application" className={styles.formPanel} aria-label="Budtender application form">
            <div className={styles.formIntro}>
              ...
              <p>
                This form sends your response to the shared Athena Store Applications sheet under KSC01. Future stores can use the same response setup with their own store key.
              </p>
