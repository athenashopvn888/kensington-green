...
export const metadata: Metadata = {
  ...
  description:
    "Visit Kensington Green at 2257 Dundas St W, Toronto, ON M6R 1X6. Open 24 hours, 7 days a week. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "2257 Dundas St W, Toronto. Open 24 hours, 7 days a week. Premium cannabis, always fire.",
  },
};
