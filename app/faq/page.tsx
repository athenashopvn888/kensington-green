...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about Kensington Green in Toronto. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Kensington Green located?", a: "We are located at 2257 Dundas St W, Toronto, ON M6R 1X6. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      { q: "What are your hours?", a: "We are open daily from 10:00 AM to 02:00 AM. Walk in anytime — no appointment needed." },
      ...
      { q: "What's the best way to get to Kensington Green?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at kensingtongreencannabis.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Kensington Green is walk-in only. Just show up anytime — we are open daily from 10:00 AM to 02:00 AM." },
      { q: "Can I order online?", a: "Currently, Kensington Green is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Kensington Green — Toronto&apos;s premium dispensary at 2257 Dundas St W in Toronto.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(416) 402-5263</strong> or visit us at 2257 Dundas St W, Toronto.
            </p>
          </div>
        </div>
        <Footer />
