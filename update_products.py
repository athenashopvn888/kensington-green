"""
Kensington Green — Product Update Script
===================================
Drop your ONHAND CSV into the kensington-green folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Kensington Green — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://kensingtongreencannabis.com")
    else:
