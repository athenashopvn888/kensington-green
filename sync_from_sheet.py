"""
Kensington Green - Auto Sync from Google Sheets
==========================================
...
a filtered menu for Kensington Green (ALC01).
...
def main():
    print("=" * 60)
    print(f"  Kensington Green - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://kensingtongreencannabis.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
