...
assert(page.includes("Weed Delivery Toronto") && !page.includes("Coming Soon"));
...
assert(footer.includes('<Link href="/weed-delivery-toronto">Weed Delivery</Link>') && !footer.includes("Delivery (Coming Soon)"));
